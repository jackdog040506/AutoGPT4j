...
public interface EngineExecutionRepository extends JpaRepository<EngineExecution, String> {
    ...
    /**
     * Find execution with all associations needed for AIThinkingProcessor
     * This loads: agent, goal, goal.taskNode, goal.taskNode.goals, goal.taskNode.goals.executions,
     * goal.taskNode.goals.executions.agent, goal.taskNode.taskNodeMaster, goal.taskNode.taskNodeMaster.agents
     */
    @EntityGraph(attributePaths = {
        ...
        "goal.taskNode",
        "goal.taskNode.goals",
        "goal.taskNode.goals.executions",
        "goal.taskNode.goals.executions.agent",
        "goal.taskNode.taskNodeMaster",
        "goal.taskNode.taskNodeMaster.agents"
    })
    Optional<EngineExecution> findWithAllAssociationsById(String id);
}