...
public class ExecutorEngine {
    ...
    private void processExecution(EngineExecution execution) {
        ...
        try {
            ...
            notifyObservers(ExecutionEvent.STARTED, execution);
            
            // Process through factory based on agent type
            ExecutionResult result = executionFactory.processExecution(execution);
            
            // Handle result
            handleExecutionResult(execution, result);
